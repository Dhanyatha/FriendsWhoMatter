...
{       
	...
	public Authenticate(OAuthConsumer oc) {
		consumer = new CommonsHttpOAuthConsumer(oc.getConsumerKey(),oc.getConsumerSecret());
	}
    public OAuthToken GetUserAccessKeySecret()
    {
        try {
            ...
            OAuthToken tokensecret = new OAuthToken(accesstoken,accesssecret);
